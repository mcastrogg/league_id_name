...
{
    [Table("league_player_matches", Schema = "historical_lol")]
    public class LeaguePlayerMatch
    {
        [NotMapped]
        ...
        public LeagueTeamPlayer LeagueTeamPlayer { get; set; }
    }
}